...
$string['settings_commentdeletionperiod_help'] = 'This is the time period (in minutes) that the Delete button will be available to students to delete their own comment (or response to a comment) once it is posted. The default period is 10 minutes. If the deletion period is set to 0, students are unable to delete their own comments. Note that teachers and administrators will always be able to edit/delete student comments, and also see the deleted comment content.';
...
$string['deletion_period_invalid'] = 'Invalid. Please input an integer.';
